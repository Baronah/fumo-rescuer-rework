...
public class Matterllurgist : EnemyBase
{
    ...
    public override void OnFirsttimePlayerSpot(bool viaAlert = false)
    {
        ...
        if (viaAlert) attackInterval = 0.5f;
    }
    ...
    public override void WriteStats()
    {
        ...
        TooltipsDescription = "Ranged unit, attacks fire 3 projectiles that deal physical damage. <color=yellow>Keeps distance</color> from the player unit. <color=yellow>If alerted early</color>, attack interval reduces.";
